...
var dugmeProvera = document.getElementById("subm");
dugmeProvera.onclick = function(){ ///event fali u funkciji 
  ...
  if(proveraGresaka(ime,nameGreska, reIme)&&proveraGresaka(surname,surnameGreska, reIme)&& proveraGresaka(email,emailGreska,reMail)&&proveraPola()&&robotProvera()&&txtProvera()){/////fali zagrada
